...
export default (monitor = 0) => {
    ...
    const SpaceCenterInteractions = (child) => Widget.EventBox({
    ...
    // The center content with tray and indicators
    const centerContent = Widget.Box({
        hpack: 'center', // This ensures it's centered within the parent
        className: 'spacing-h-5 bar-spacecenter',
        children: [
            barTray,
            Widget.Box({
                children: [
    ...
    return Widget.EventBox({
        ...
        child: SpaceCenterInteractions(centerContent)
    });
} 